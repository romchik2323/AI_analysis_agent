# 🤖 AI-Powered Churn Analysis Agent

**Python • LLM • MCP • RAG • FastAPI • Machine Learning**

Агентная система предсказания и анализа оттока клиентов с поддержкой Claude API, локального Qwen2.5 и семантическим поиском на E5-large. Универсальный ML-пайплайн работает с любым табличным датасетом.
